...
public:
	...
	CVector v_correlation_single_point_diffusion(const CPosition &pp, double dt0, double diffusion_coefficient);
	...
	CBTCSet get_correlation_based_on_random_samples_diffusion(int nsamples, double dt0, double diffusion_coeff);
